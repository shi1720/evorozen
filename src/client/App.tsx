        ...
        >
          ...
          <div className="workspace-switch">
            ...
            <div>
              ...
              <span>{user.isDemo ? 'Sample workspace' : 'Your workspace'}</span>
            </div>
            <ChevronDown size={14} />
          </div>
          ...
          <div className="sidebar-bottom">
            <div className="sidebar-note">
              <div>
                <ShieldCheck size={18} />
                <b>Good records. Clear answers.</b>
              </div>
              <p>
                Every finding has a source.
                <br />
                Every next step is yours.
              </p>
            </div>
            <NavLink
              to="/app/settings"
            ...
            <div className="user-bar">
              ...
              <div>
                ...
                <span>{user.isDemo ? 'Demo explorer' : 'Workspace owner'}</span>
              </div>
        ...
        <div className="workspace-main">
          <header className="app-topbar">
            ...
            <div className="breadcrumb">
              Workspace <span>/</span>{' '}
              <b>
                {loc.pathname.includes('/cases/')
                  ? 'Case detail'
                  : nav.find((x) => x.to === loc.pathname)?.label || 'Settings'}
              </b>
            </div>
            <div className="topbar-right">
              ...
              <Link className="topbar-help" aria-label="Help and setup" to="/app/settings">
                <CircleHelp size={17} />
          ...
          {user.isDemo && (
            <div className="demo-banner">
              <span>
                <Sparkles size={15} />
                <b>You’re exploring sample data.</b> AI results are a labeled replay; changes stay
                in your own demo workspace.
              </span>
              <Link to="/signup">
          ...
          <footer className="app-footer">
            <span>Small details. All accounted for.</span>
            <span>
              Remainder <i /> <Link to="/privacy">Privacy</Link>
            </span>
          </footer>
        </div>
      </div>
...
export function App() {
  ...
  return (
    <>
      ...
      <Routes>
        <Route path="/" element={<Landing onDemo={demo} busy={busy} />} />
        {(['login', 'signup', 'recover'] as const).map((mode) => (
          <Route
            key={mode}
            path={`/${mode}`}
            element={
        ...
        <Route
          ...
          element={
            <div className="not-found">
              ...
              <p>Let’s get you back to something accounted for.</p>
